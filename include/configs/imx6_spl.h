...
#else
#define CONFIG_SPL_BSS_START_ADDR	0x18200000       /*182*/
#define CONFIG_SPL_BSS_MAX_SIZE		0x100000	/* 1 MB */
#define CONFIG_SYS_SPL_MALLOC_START	0x18300000      /*183*/
#define CONFIG_SYS_SPL_MALLOC_SIZE	0x3200000	/* 50 MB */
#define CONFIG_SYS_TEXT_BASE		0x17800000     /*commit 0x17800000*/
#endif
#endif
